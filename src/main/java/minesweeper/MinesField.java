...
/**
 * StonesField represents playing field and game logic.
 */
public class MinesField {
	...
	/**
	 * StonesField row count. Rows are indexed from 0 to (rowCount - 1).
	 */
	...
	public int getRemainingMineCount(){
		int number;
		number=mineCount-getNumberOf(Tile.State.MARKED);
		return number;
	}
